...
def test_sensitivity():
    base_config_path = Path("campaign/config_material.yaml")
    out_dir = Path("outputs/material_state_outputs")
    ...
    for th in thresholds:
        ...
        test_cfg_path = Path(f"campaign/config_material_test_{th}.yaml")
